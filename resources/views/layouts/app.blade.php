...
<!-- Material Design -->
<script src="{{asset('js/dist/js/material.min.js')}}"></script>
<script src="{{asset('js/dist/js/ripples.min.js')}}"></script>
<script>
    $.material.init();
</script>
<script src="{{asset('js/bower_components/bower_components/moment/min/moment.min.js')}}"></script>
<!-- Bootstrap WYSIHTML5 -->
